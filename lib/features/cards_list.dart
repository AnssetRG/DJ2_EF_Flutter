...
import 'package:vulneracion_tarjetas/model/card.dart';
import 'package:vulneracion_tarjetas/features/add_card.dart';

import 'package:qrscan/qrscan.dart' as scanner;
import 'package:vulneracion_tarjetas/utils/utils.dart';
...
class _CardsListState extends State<CardsListScreen>{
  List<Tarjeta> cards;
  
  @override
  void initState() {
    cards = new List<Tarjeta>();
    cards.add(new Tarjeta(image: "assets/images/image 10.png", name: "Master Card"));
    cards.add(new Tarjeta(image: "assets/images/image 11.png", name: "VISA"));
    cards.add(new Tarjeta(image: "assets/images/image 12.png", name: "JCB"));
    cards.add(new Tarjeta(image: "assets/images/image 13.png", name: "American Express"));
                      ...
                      children: [
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context,i){
                            return TarjetaModel(image: cards[i].image, name: cards[i].name);
                          },
                        ),
                        SizedBox(height: 20),
                        GestureDetector(
